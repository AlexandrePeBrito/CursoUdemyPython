#Faça um programa que leia dois números a e b (positivos 
#menores que 10000) e:
...
#Dica: some as posições correspondentes. Se a soma 
#ultrapassar 10, subtraia 10 do resultado e some 1 à próxima
#posição.
