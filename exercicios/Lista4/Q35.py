...
e Crie um vetor onde cada posição é um algarismo do número. A primeira posição é
o algarismo menos significativo;
e Crie um vetor que seja a soma de a e b, mas faça-o usando apenas os vetores
